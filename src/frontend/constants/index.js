import MarketplaceAddress from '../../backend/contractsData/localhost/Marketplace-address.json';
import MarketplaceAbi from '../../backend/contractsData/localhost/Marketplace.json';
import NFTAddress from '../../backend/contractsData/localhost/NFT-address.json';
import NFTAbi from '../../backend/contractsData/localhost/NFT.json';
import MarketplaceAddressGoerli from '../../backend/contractsData/goerli/Marketplace-address.json';
import MarketplaceAbiGoerli from '../../backend/contractsData/goerli/Marketplace.json';
import NFTAddressGoerli from '../../backend/contractsData/goerli/NFT-address.json';
import NFTAbiGoerli from '../../backend/contractsData/goerli/NFT.json';
